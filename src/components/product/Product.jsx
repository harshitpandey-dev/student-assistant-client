        ...
        <Card.Body>
          ...
          <div className="d-flex mt-4 flex-wrap">
            {isYourProduct ? (
              <>
                <a
                  className="btn style-btn style-btn-chat  text-light"
                ...
                <Link
                  ...
                  className={
                    isWishlisted
                      ? "btn text-light bg-success btn-circle btn-circle-sm m-1 style-btn-wishlist-pro style-btn"
              ...
              <>
                <Link
                  to={`/chatScreen/${product.owner?._id}`}
                  className="btn text-light style-btn style-btn-chat  text-light"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="35px"
