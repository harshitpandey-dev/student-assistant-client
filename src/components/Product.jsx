      ...
      <Card className='my-3 p-3 rounded product-card'>
        ...
        <Card.Body>
          ...
          <Card.Text as='h3' className='text-success ' style={{ fontSize: "33px", fontWeight: "bold" }}>Rs {product.cost.price} </Card.Text>
            {product && product.owner._id!==userID && <Link to={`/chat/${product.owner._id}`} className='btn btn-outline-dark'> <svg xmlns="http://www.w3.org/2000/svg" width="50px" height="30px" fill="currentColor" className="bi bi-chat" viewBox="0 0 16 16">
