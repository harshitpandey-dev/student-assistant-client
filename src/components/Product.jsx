    ...
    <>
      <Card className='my-3 p-3 rounded product-card'>
        ...
        <Card.Body>
          ...
          <Link to="/chat" className='btn btn-outline-dark'> <svg xmlns="http://www.w3.org/2000/svg" width="50px" height="30px" fill="currentColor" className="bi bi-chat" viewBox="0 0 16 16">
