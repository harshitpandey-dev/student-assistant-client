...
export default function WhislistCard({ image, name, price, id, product }) {
  ...
  return (
        <div className="d-flex flex-row flex-wrap m-3 position-relative  text-dark wishcard" style={{width:"510px",height:"400px",maxWidth:"100vw"}}>
      ...
      <div className=" d-flex flex-column align-items-center justify-content-center fix-right" style={{ width: "345px", maxWidth: "100vw" }}>
              <div className="name-product fs-2">
                  ...
                  <p className="price text-success">
                      <span>₹ {price} {product?.cost?.negotiable && (
                          <span className="text-warning fw-bold" style={{ fontSize: "10px" }}>
                              Negotiable
                          </span>
       ...
       <div onClick={handleWishlist} className="trash-icon  position-absolute removeWish" style={{top:"-3px" ,right:"10px",cursor:"pointer",width:"30px",height:"40px"}}>
        <CiSquareRemove className='text-danger fs-1' />
          </div>
       <div  className=" position-absolute button-3 fix-btn" style={{bottom:"10px" ,right:"10px",cursor:"pointer"}}>
