...
export const USER_VERIFICATION_LINK_REQUEST = 'USER_VERIFICATION_LINK_REQUEST'
export const USER_VERIFICATION_LINK_SUCCESS = 'USER_VERIFICATION_LINK_SUCCESS'
export const USER_VERIFICATION_LINK_FAIL = 'USER_VERIFICATION_LINK_FAIL'
export const USER_VERIFICATION_LINK_RESET = 'USER_VERIFICATION_LINK_RESET'
